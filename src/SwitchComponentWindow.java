...
public class SwitchComponentWindow extends JFrame{

	private static final long serialVersionUID = 1L;
	private SwitchComponent component;
	private JPanel cont;
	
	public SwitchComponentWindow(int width, int height, LayoutManager panLayout, SwitchComponent givenComponent){
	...
	public void createInformations(){
    	...
    	yPos+=SpaceHeight;
    	//Switch type
    	JLabel componentLabelSwitchType = new JLabel();
    	componentLabelSwitchType.setBounds(0,yPos, 50, 15);
    	componentLabelSwitchType.setText("Type :");
    	JComboBox<String> componentSwitchTypeList = new JComboBox<String>();
    	componentSwitchTypeList.setBounds(componentLabelSwitchType.getWidth(),yPos,this.getWidth()-componentLabelSwitchType.getWidth()-componentSwitchTypeList.getLocation().x-10,20);
    	componentSwitchTypeList.addItem("ovsk");
    	componentSwitchTypeList.addItem("user");
    	componentSwitchTypeList.setSelectedItem(component.getSwitchType());
    	this.add(componentLabelSwitchType);
    	this.add(componentSwitchTypeList);
	...
	private void updateInformations(){
		...
		component.setSwitchType(String.valueOf(((JComboBox<?>)cont.getComponent(14)).getSelectedItem()));
